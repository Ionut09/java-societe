package com.societe._3_classes.exercise;

public class TestingCode {

    /**
     * A complex number is a number that can be expressed in the form a + bi, where a
     * and b are real numbers, and i is a solution of the equation x^2 = −1. Because no real
     ...
     * - Method named subtract with two parameters real and imaginary of type double, it
     * needs to subtract parameters from fields, in other words, it needs to do a complex
     * number subtract operation as described above.
     * - Method named subtract with one parameter other of type ComplexNumber. It needs
     * to subtract the other parameter from this complex number.
     */
    public static void main(String... args) {
//        ComplexNumber one = new ComplexNumber(1.0, 1.0);
//        ComplexNumber number = new ComplexNumber(2.5, -1.5);
//
//        var other = new ComplexNumber(1, 1);
//        one.add(other);
